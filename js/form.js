class Form {
  ...
  validateForm = () => {
    if (this.nameValid && this.emailValid && this.subjectValid && this.messageValid) {
      this.formValid = true;
    } else {
      this.formValid = false;
    }
  ...
  manageClasses = () => {
    ...
    this.emailValid ? this.email.parentNode.classList.add('valid') : this.email.parentNode.classList.remove('valid');

    this.subjectValid ? this.subject.parentNode.classList.add('valid') : this.subject.parentNode.classList.remove('valid');

    this.messageValid ? this.message.parentNode.classList.add('valid') : this.message.parentNode.classList.remove('valid');
